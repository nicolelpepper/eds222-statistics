...
rootdir <- "~nicolepepper/Documents/MEDS/eds-222/eds222-labs"
...
```{r}
# First step is to explore your data
...
ggplot(data = loans_sum) + 
  geom_col(aes(x = homeownership, y=n/sum(n)), 
           fill = "lightblue") + 
  theme_bw() + 
  labs(x = "Homeownership", y = "Percentage of Sample")
```
...
loans %>%
  ...
  labs(x = "\n Homeownership", y = "\n Total", title = "Homeownership Rates \n") +
  theme_minimal()
...
ggplot(data = loans) + 
  ...
  labs(x = "Interest Rate", title = "Interest Rates")
