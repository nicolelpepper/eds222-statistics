...
2.  What does the intercept tell you, in words?
    ...
    B0 –\> Intercept for 0 is positive

    Car with infinitsmly small car when x2 = 0 (1999)

    x =1 is 2008

3.  What does the coefficient on `displ` tell you, in words?

    This is B1: slope at 0

    This value indicates a negative slope in 1999

    When you compare with b hat 3 you see it gets less steep (positive b hat 3)

4.  What does the coefficient estimate on the 2008 vintage indicator variable (`year2008`) tell you, in words?

    Bhat 2 = intercept at 2008

    Infinitesmly small car when x2 = 1 (2008)

5.  What does the coefficient on `displ:year2008` tell you, in words?[^1]

    Similar slope but slightly less steep
...
Bhat 0 (INTERCEPT) = intercept at 0

Bhat 1 (DISPL) = slope for 0

Bhat 2 (YEAR2008)= intercept at

Bhat 3(DIPL:YEAR2008) = whether slope is more extreme than other
